...
rb \le \left\lceil \frac{n}{b} \right\rceil < \frac{n}{b} + 1 \implies &rb^2 - b - n < 0 \implies b < \frac{1}{2r}+\sqrt{\frac{1}{4r^2} + \frac{n}{r}} \\
    \implies &b < \frac{1}{2} + \sqrt{\left(\frac{1}{2} + \sqrt{\frac{n}{r}}\right)^2} = b^* + 1 \\
\end{aligned}
$$
...
$$
s = \max_{\substack{\lfloor b^* \rfloor \le b \le \lceil b^* \rceil \\[0.1em] b > 0}} \min \left\{\frac{w}{\left\lceil \frac{n}{b} \right\rceil}, \frac{h}{b} \right\}
$$
